if pcall(require, "harpoon") then
  ...
  vim.keymap.set("n", "<leader>h", function() require('harpoon.ui').toggle_quick_menu() end,
    { noremap = true, silent = true })
  vim.keymap.set({ "n", "i" }, "<C-h>", function() require('harpoon.ui').nav_file(1) end,
    { noremap = true, silent = true })
  vim.keymap.set({ "n", "i" }, "<C-j>", function() require('harpoon.ui').nav_file(2) end,
    { noremap = true, silent = true })
  vim.keymap.set({ "n", "i" }, "<C-k>", function() require('harpoon.ui').nav_file(3) end,
    { noremap = true, silent = true })
